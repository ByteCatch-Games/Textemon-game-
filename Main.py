...
for t in types:
    ...
    if t == "Normal":
        ...
        strengths = ["Poison", "Electric", "Rock"]
        
    elif t == "Flying":
        weaknesses = ["Electric", "Ice", "Rock"]
        strengths = ["Grass", "Fighting", "Bug","Ground"]
        ...
        strengths = ["Poison", "Normal","Fighting","Bug"]
        ...
        strengths = ["Psychic", "Ghost","Dark"]
        
    elif t == "Steel":
        weaknesses = ["Fire", "Fighting", "Ground"]
        strengths = ["Normal", "Grass", "Ice","Poison","Flying","Psychic","Bug","Rock","Dragon","Steel","Fairy"]
        
    elif t == "Fairy":
        weaknesses = ["Poison", "Steel"]
        strengths = ["Fighting", "Dragon", "Dark","Bug"]
...
Defensive moves: {chosen_one.defensive_moves1[0][0]}(uses 3 energy),{chosen_one.defensive_moves2[0][0]}(uses 3 energy)""")
            ...
            if choice==1:
                ...
                if chosen_one.speed>chosen_one_speed:
                    print(f"{chosen_one.name}'s speed increased")
                if chosen_one_check<chosen_one.offensive_moves1[0][1] and chosen_one.offensive_moves3[0][2]>chosen_one_check:
                    print(f"{chosen_one.name}'s attack increased")
                if chosen_one.hp>chosen_one.max_hp:
                    chosen_one.hp=chosen_one.max_hp
                chosen_one.energy=chosen_one.energy-3
