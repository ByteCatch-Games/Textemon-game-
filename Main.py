...
#core engine
class Pokemon:
    def __init__(self, name, element, max_hp, max_energy,speed,heal):
        self.name = name
...
pikachu = Pokemon("Pikachu", ["Electric"], 400, 60,90,20)
...
charizard = Pokemon("Charizard", ["Fire", "Flying"], 520, 50,100,5)
...
blastoise = Pokemon("Blastoise", ["Water"], 520, 50,78,15)
...
blastoise.add_defensive_move1("Protect", 1,0,0,1,0,)
blastoise.add_defensive_move2("Withdraw", 0.5,0,0,None,0,)

# create a Venusaur instance with moves
venusaur = Pokemon("Venusaur", ["Grass", "Poison"], 520, 50,80,10)
...
lycanroc = Pokemon("Lycanroc", ["Rock"], 480, 45,112,10)
...
beedrill = Pokemon("Beedrill", ["Bug", "Poison"], 400, 60,75,10)
...
beedrill.add_defensive_move2("Protect", 1,0,0,1,0,)

# create a Crobat instance with types Poison and Flying
crobat = Pokemon("Crobat", ["Poison", "Flying"], 400, 60,130,5)
...
gengar = Pokemon("Gengar", ["Ghost", "Poison"], 440, 60,110,10)
...
metagross = Pokemon("Metagross", ["Steel", "Psychic"], 520, 45,70,5)
...
noivern = Pokemon("Noivern", ["Flying", "Dragon"], 480, 50,123,5)
...
noivern.add_defensive_move2("Protect", 1,0,0,1,0,)

# create a Garchomp instance with types Dragon and Ground
garchomp = Pokemon("Garchomp", ["Dragon", "Ground"], 560, 40,102,5)
...
krookodile = Pokemon("Krookodile", ["Ground", "Dark"], 440, 55,92,10)
...
krookodile.add_defensive_move1("Sandstorm", 0,0,0.5,None,0,)
krookodile.add_defensive_move2("Swagger", -0.1,0,.3,None,0,)


# Create a Tyranitar instance
tyranitar = Pokemon("Tyranitar", ["Dark", "Rock"], 480, 40,61,5)
...
tyranitar.add_defensive_move1("Protect", 1,0,0,1,0,)
tyranitar.add_defensive_move2("Sandstorm", 0,0,0.5,None,0,)

# Create a Machamp instance
machamp = Pokemon("Machamp", ["Fighting"], 440, 55,55,10)
...
gardevoir = Pokemon("Gardevoir", ["Psychic", "Fairy"], 400, 60,80,20)
...
mimikyu = Pokemon("Mimikyu", ["Ghost", "Fairy"], 400, 60,96,15)
...
mimikyu.add_defensive_move1("Protect", 1, 0, 0,1,0,)
mimikyu.add_defensive_move2("Substitute", 1,-25,0,2,0,)

# Create a Silvally instance
silvally = Pokemon("Silvally", ["Normal"], 480, 55,95,15)
...
cryogonal = Pokemon("Cryogonal", ["Ice"], 400, 60,105,20)
...
Heal:{chosen_one.heal}""")
            ...
            while choice==choice:
                if choice=="1":
                    random_pokemon.hp= random_pokemon.hp - ((chosen_one.offensive_moves1[0][1])*chosen_one_damage_1)
                    ...
                    random_pokemon.hp= random_pokemon.hp - ((chosen_one.offensive_moves2[0][1])*chosen_one_damage_2)
                    chosen_one.energy=chosen_one.energy-1
                    ...
                    random_pokemon.hp= random_pokemon.hp - ((chosen_one.offensive_moves3[0][1])*chosen_one_damage_3)
                    chosen_one.energy=chosen_one.energy-1
...
{random_pokemon.name}   hp:{random_pokemon.hp}   energy:{random_pokemon.energy} heals:{random_pokemon.heal}""")
        ...
        if random_pokemon.energy<=0:
            ...
            if chosen_one.hp-(random_pokemon.offensive_moves1[0][1]*random_pokemon_damage_1)<=0:
                chosen_one.hp=chosen_one.hp-(random_pokemon.offensive_moves1[0][1]*random_pokemon_damage_1)
                ...
                chosen_one.hp=chosen_one.hp-(random_pokemon.offensive_moves2[0][1]*random_pokemon_damage_2)
                random_pokemon.energy-=1
                ...
                if random_pokemon_damage2>1:
                    ...
                    print("It's not effective")
                print()
            elif chosen_one.hp-(random_pokemon.offensive_moves3[0][1]*random_pokemon_damage_3)<=0:
                chosen_one.hp=chosen_one.hp-(random_pokemon.offensive_moves3[0][1]*random_pokemon_damage_3)
                random_pokemon.energy-=1
